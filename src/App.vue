  ...
  <div class="grow flex flex-col">
    ...
    <main class="grow container">
      ...
      <div class="default-grid bg-white/50 py-8">
        ...
        <h1 class="text-6xl col-span-full text-black md:col-start-3 md:col-span-8 lg:col-start-4 lg:col-span-6">
          Headline</h1>
        <p
        ...
        <div class="col-span-full md:col-start-3 md:col-span-8 lg:col-start-4 lg:col-span-6 text-black">
          <h3 class="mt-4 text-2xl">Where did you start your trip?</h3>

          <label for="city" class="text-black mt-6 block">Stadt, Ort oder
            Adresse</label>
          <input type="text" class="bg-white px-3 py-2 block w-full" placeholder="Enter a place or city"
            v-model="cityInputModel" @keyup="onKeyUp" v-if="loaded" />
        ...
        <div class="col-span-full md:col-start-3 md:col-span-8 lg:col-start-4 lg:col-span-6 mt-10 bg-white/50 p-4"
          v-if="distanceMeters">
